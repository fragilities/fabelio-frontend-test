    ...
    return (
        <div className="flex flex-col w-5/12 shadow p-4 mb-6 rounded">
            <div className="flex justify-between mb-2">
                ...
                <span className="text-gray-800">{props.product.price}</span>
            </div>
            <p className="text-gray-700 mb-2">{props.product.description}</p>
            <div className="flex items-center mb-2">
                {props.product.furniture_style &&
                props.product.furniture_style.length > 0 ? (
